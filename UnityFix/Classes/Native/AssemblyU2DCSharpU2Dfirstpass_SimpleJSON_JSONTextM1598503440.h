...
struct  JSONTextMode_t1598503440 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(JSONTextMode_t1598503440, ___value___1)); }
