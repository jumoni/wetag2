...
struct  SignatureHelperType_t3787824872 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SignatureHelperType_t3787824872, ___value___1)); }
